      ...
      <div className="container">
        ...
        <div className="why-content">
          <p>
            ...
            «Империал Холдинг». Мы готовы к сотрудничеству и приглашаем
            заказчиков в мир высококачественного шитья.
          </p>

          <p>
            🧵 Точная стоимость будет уточнена после создания образца. Стоимость
            изготовления одного образца составляет 3000 рублей, включая работу
            над образцом по фото/видео и печать лекала.
          </p>

          <p>
            Минимальный объем заказа начинается с 500 штук одной расцветки
            модели.
          </p>
          ...
          <p>
            Наша производственная мощность позволяет нам шить от 4000 до 5000
            тысяч изделий в неделю, в зависимости от типа продукции.
          </p>
