    ...
    <div className='about'>
      <div className='container'>
        ...
        <div className='about-text'>
          <p>Компания IMPERIAL-HOLDING - успешное швейное производство, базирующееся Кыргызстане и специализирующееся на создании высокачественной одежды для крупных маркетплейсов.</p>
          <p>Готовы исследовать мир стиля и качества? Присоединяйтесь к нашему телеграмм каналу <a href="#">"IMPERIAL-HOLDING"!</a>Там вас ожидают эксклюзивные предложения и актуальные цены.</p>
          <p>Наше производство <br /> IMPERIAL HOLDING уже 6 лет успешно сотрудничает с оптовыми клиентами и выполнила более миллиона заказов для крупных маркетплейсов, таких как Wildberries и Ozon.</p>
            ...
            <p>IMPERIAL HOLDING - надежный и долгосрочный партнер более чем для 20 крупных брендов. Мы гарантируем высокое качество пошива, индивудиальный подход к каждому заказу и оперативное выполнение работ.</p>
        ...
        <div className='about-description'>
          ...
          <div className='descripton-content'>
            ...
            <div className='about-right'>
              ...
              <div className='about-right-pay'>Оплата на расчетный счёт, и доставка через карго</div>
            </div>
          </div>
        </div>
      </div>
