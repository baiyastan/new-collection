      ...
      <section className="about-text">
        <div className="container">
          ...
          <p>
            ...
            Там вас ожидают эксклюзивные предложения и актуальные цены.
          </p>
          <p>
            Наше производство <br /> IMPERIAL STYLE уже 6 лет успешно
            сотрудничает с оптовыми клиентами и выполнила более чем 100 тысяч
            заказов для крупных маркетплейсов, таких как Wildberries и Ozon.
          </p>
          <p>
            IMPERIAL STYLE - надежный и долгосрочный партнер более чем для 40
            крупных брендов. Мы гарантируем высокое качество пошива,
            индивудиальный подход к каждому заказу и оперативное выполнение
            работ.
          </p>
          <p>
            Не уступите возможность получить выгодное предложение вашего
